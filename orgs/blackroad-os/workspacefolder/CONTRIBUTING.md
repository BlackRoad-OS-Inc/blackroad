# Contributing to workspacefolder
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/workspacefolder.git
cd workspacefolder

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/workspacefolder.git
