...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/slashcommand.git
cd slashcommand

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/slashcommand.git
