...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/control-map.git
cd control-map

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/control-map.git
