...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">ai.blackroad.io</div>
    <h1>AI Platform</h1>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'ai.blackroad.io', description: 'AI Platform', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
