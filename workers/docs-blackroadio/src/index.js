// docs.blackroad.io — Documentation Hub
...
<head>
  ...
  <title>Documentation Hub — BlackRoad OS</title>
  <style>
...
<body>
  ...
  <div class="hero">
    ...
    <div class="subdomain">docs.blackroad.io</div>
  ...
  <div class="data-section">
    <div class="data-card">
      ...
      <pre>${JSON.stringify({ subdomain: 'docs.blackroad.io', description: 'Documentation Hub', health: health.status || 'ok', agents_online: agentCount, timestamp: now }, null, 2)}</pre>
    </div>
  </div>
